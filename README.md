...
* **Continuous Growth** 🌱💡: Constantly expanding knowledge across the IT spectrum, from software development to systems, networking, and infrastructure.
* **Programming & Development** 💻🛠️: Enhancing skills in both web and server-side programming, as well as database design and management.
* **Systems & DevOps** 🐧⚙️: Deepening expertise in Linux, containerization (Docker, Kubernetes), self-hosting, and operating system internals.
* **Cybersecurity & Ethical Hacking** 🔒🕵️‍♂️: Building proficiency in security practices, penetration testing, and defensive strategies.
* **Practical Experience & Exploration** 🚀🔍: Continuously experimenting with new technologies, server architectures, and IT solutions to strengthen real-world skills.
...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,ts,bootstrap,tailwind,cpp,cs,dotnet,py,mysql,postgres,bash,powershell,docker,kubernetes,git,github,linux,kali,bsd,clion,rider,webstorm,vscode)](https://skillicons.dev)
